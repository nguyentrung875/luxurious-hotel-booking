...
$(function () {
  ...
  /*======== 7. Single date picker (Custom page: rooms.html) ========*/

  if ($("#custom_single_datepicker")) {
    var start = moment();
    var cb = function (start) {
      $("#custom_single_datepicker .lh-date-range span").html(

        "<a href='javascript:void(0)' class='calendar' title='Date'><i class='ri-calendar-line'></i>" + start.format("ll") + "</a>"
      );
    };

    $("#custom_single_datepicker").daterangepicker({
      singleDatePicker: true,
      showDropdowns: true,
      minYear: 2020,
      maxYear: 2030,
